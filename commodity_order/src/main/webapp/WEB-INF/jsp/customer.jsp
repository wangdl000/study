...
<!-- Bootstrap Core CSS -->
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/bootstrap.min.css" rel="stylesheet" />
<!-- MetisMenu CSS -->
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/metisMenu.min.css" rel="stylesheet" />
<!-- DataTables CSS -->
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/dataTables.bootstrap.css" rel="stylesheet" />
<!-- Custom CSS -->
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/sb-admin-2.css" rel="stylesheet" />
<!-- Custom Fonts -->
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/font-awesome.min.css" rel="stylesheet" />
<link type="text/css" href="${pageContext.request.contextPath}/customer_sample/css/boot-crm.css" rel="stylesheet" />

<!-- jQuery -->
<script src="${pageContext.request.contextPath}/customer_sample/js/jquery.min.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="${pageContext.request.contextPath}/customer_sample/js/bootstrap.min.js"></script>
<!-- Metis Menu Plugin JavaScript -->
<script src="${pageContext.request.contextPath}/customer_sample/js/metisMenu.min.js"></script>
<!-- DataTables JavaScript -->
<script src="${pageContext.request.contextPath}/customer_sample/js/jquery.dataTables.min.js"></script>
<script src="${pageContext.request.contextPath}/customer_sample/js/dataTables.bootstrap.min.js"></script>
<!-- Custom Theme JavaScript -->
<script src="${pageContext.request.contextPath}/customer_sample/js/sb-admin-2.js"></script>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="list.action">BOOT客户管理系统 v2.0</a>
		</div>
		<!-- /.navbar-header -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/customer/detail.action",
				data:{"id":id},
