...
exports.config = {
	...
	//    
	onPrepare : function() {
		console.log('Chromeでの自動化テスト(PC)開始：' + format);
...
//	specs : ['spec/spec/*_PC_spec.js'], // 一括テスト実施：全部
	specs : ['spec/spec/0*_PC_spec.js'], // 一括テスト実施：正常系
//	specs : ['spec/1*_PC_spec.js'], // 一括テスト実施：入力チェックエラー
//	specs : ['spec/2*_PC_spec.js'], // 一括テスト実施：異常系
