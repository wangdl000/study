...
exports.config = {
	...
	//
	onPrepare : function() {
		console.log('IEでの自動化テスト開始：' + format);

		global.browser_name = 'ie';

		global.folder = "screenshots/captures_windows/ie_" + format ;
...
//	specs : ['spec/*_spec.js'], // 一括テスト実施：全部
//	specs : ['spec/0*_spec.js'], // 一括テスト実施：正常系
//	specs : ['spec/1*_spec.js'], // 一括テスト実施：入力チェックエラー
//	specs : ['spec/2*_spec.js'], // 一括テスト実施：異常系
//	specs : ['spec/00_login*_spec.js', '2*_spec.js'], // 一括テスト実施：正常系（ログイン画面）と異常系
	
//	specs : ['spec/00_login_PC_spec.js'], // ログイン(PC)
//	specs : ['spec/00_login_SP_spec.js'], // ログイン(SP)
	specs : ['spec/01_transfer_*_spec.js'], // 振込(PC)
