describe('angularjs homepage todo list', function() {
	it('should add a todo',function() {
		...
		// mode. PC:1; SP: 2
		var mode = 1;
		var url = "http://localhost/SFC/apps/services/www/SFC/desktopbrowser/default/index.html?mode=" + mode;
		var pageId = "";
		var inputMode = "";
		browser.get(url);
		console.log('Step 0');
		...
		browser.sleep(1000);
		inputMode = "password";
		var promiseA = element(by.css('[ng-model="' + inputMode + '"]')).sendKeys(pwd_cell.v);
		browser.sleep(1000);
		...
		pageId = "'CP0003_002'";
		var promiseTransfTop = element(by.css('[ng-bind="(' + pageId + ' | translate)"]')).click();
		...
		var promiseTransf = element(
				by.css('[ng-bind="(' + pageId
						+ ' | translate)"]')).click();
		...
		var promiseAcountBtn = element(by.css('[ng-bind="(' + pageId + ' | translate)"]')).click();
		...
		console.log('Step 6' + "pageId: [" + pageId + "]. \n");
		var promiseBank = element(by.css('[tabindex="1093"]'))
				.click();
		...
		console.log('Step 7' + "branch: [" + branch_cell_value+ "]. " + "pageId: [" + pageId + "]. \n");
		var promiseInputBranck = element(
				by.css('[ng-model="' + inputMode + '"]'))
		...
		console.log('Step 6' + "明石支店> : tabindex[ 1362]. \n"); // TODO
																// 問題ある
		var promiseBranch = element(by.css('[tabindex="1362"]'))
				.click();
		...
		console.log('Step 9' + "branch: ["
				+ accountNum_cell_value + "]. " + "pageId: ["
				+ pageId + "]. \n");
		var promiseAccountNum = element(
				by.css('[ng-model="' + inputMode + '"]'))
